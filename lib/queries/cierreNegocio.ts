...
const RESUMEN_SQL = `
  SELECT
    ...
    SAFE_CAST(gasto_presupuestado AS FLOAT64) AS gastoPresupuestado,
    SAFE_CAST(presupuesto_gasto_items AS FLOAT64) AS presupuestoGastoItems,
    SAFE_CAST(lineas_presupuesto AS FLOAT64) AS lineasPresupuesto,
    SAFE_CAST(utilidad_presupuestada AS FLOAT64) AS utilidadPresupuestada,
