...
// Switcher persistente del grupo MARKETING para CURVAS DE VENTA. La auth ya la
// resuelve el layout padre (app/marketing/layout.tsx).
export default async function CurvasLayout({
  children,
}: {
  ...
  return (
    <>
      <GroupNav group={MARKETING_GROUP} active="marketing.curvas" members={members} />
